...
if __name__ == '__main__':
    rospy.init_node('world_aruco_ID_4_tf_listener')
    ...
    pub_aruco_world_pose = rospy.Publisher("world_to_aruco_ID_4/target_pose", geometry_msgs.msg.Pose,queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        try:
            ...
            (position,orientation) = listener.lookupTransform("world", "camera_aruco_ID_4", rospy.Time(0))
