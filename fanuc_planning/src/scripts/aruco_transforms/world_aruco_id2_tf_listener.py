...
if __name__ == '__main__':
    rospy.init_node('world_aruco_ID_2_tf_listener')
    ...
    pub_aruco_world_pose = rospy.Publisher("world_to_aruco_ID_2/target_pose", geometry_msgs.msg.Pose,queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        try:
            ...
            (position,orientation) = listener.lookupTransform("world", "camera_aruco_ID_2", rospy.Time(0))
