...
if __name__ == '__main__':
    rospy.init_node('world_assembly_part_ID_1_tf_listener')
    ...
    pub_aruco_world_pose = rospy.Publisher("world_assembly_part_ID_1/target_pose", geometry_msgs.msg.Pose,queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        try:
            ...
            (position,orientation) = listener.lookupTransform("world", "assembly_part_ID_1", rospy.Time(0))
